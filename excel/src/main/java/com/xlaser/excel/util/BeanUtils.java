...
import com.xlaser.excel.excel.DictInfo;

import static com.xlaser.excel.constant.CopyConsts.DICT_TYPES;
import static com.xlaser.excel.constant.CopyConsts.INDEX_TYPES;
...
public class BeanUtils {
	 ...
	 *
	 * <p>1.类型list,字段为索引信息的字段eg:{@link com.xlaser.excel.excel.ColumnInfo#indexDetail}的字段
	 *
	 * <p>2.类型list,字段为字典类型eg:{@link com.xlaser.excel.excel.TableInfo#businessType}的字段
	 *
	 * @param source 源DTO
	 * @param target 目DO
	 */
