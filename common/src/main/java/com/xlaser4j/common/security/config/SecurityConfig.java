package com.xlaser4j.common.security.config;

import cn.hutool.extra.servlet.ServletUtil;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.xlaser4j.common.response.ApiResponse;
import com.xlaser4j.common.security.model.HrDO;
import com.xlaser4j.common.security.service.IUserService;
...
import static com.xlaser4j.common.enums.Status.LOGIN;
import static com.xlaser4j.common.enums.Status.LOGOUT;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    private final IUserService hrService;

    private final CustomDecisionManager decisionManager;

    private final CustomSecurityFilterMetadata securityFilter;

    public SecurityConfig(IUserService hrService, CustomDecisionManager decisionManager, CustomSecurityFilterMetadata securityFilter) {
