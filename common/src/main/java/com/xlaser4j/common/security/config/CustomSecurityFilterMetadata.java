...
import com.xlaser4j.common.security.model.RoleDO;
import com.xlaser4j.common.security.model.SecurityMenuVO;
import com.xlaser4j.common.security.service.IMenuService;
...
public class CustomSecurityFilterMetadata implements FilterInvocationSecurityMetadataSource {
    ...
    public Collection<ConfigAttribute> getAttributes(Object o) throws IllegalArgumentException {
        ...
        if (first.isPresent()) {
            ...
            return org.springframework.security.access.SecurityConfig.createList(roleNames);
        } else {
            return org.springframework.security.access.SecurityConfig.createList("anyone_login");
        }
    }
